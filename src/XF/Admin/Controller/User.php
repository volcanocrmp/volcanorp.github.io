...
class User extends AbstractController
{
	...
	public function actionRemoveLikes(ParameterBag $params)
	{
		$user = $this->assertUserExists($params->user_id);
		...
		if ($this->isPost())
		{
			...
			$this->app->jobManager()->enqueue('XF:UserRemoveLikes', [
				'userId' => $user->user_id,
				'cutOff' => $cutOff
			], true);
		...
		else
		{
			...
			return $this->view('XF:User\RemoveLikes', 'user_remove_likes', $viewParams);
		}
	}
