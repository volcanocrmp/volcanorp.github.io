...
a.find(d.options.editContainer);b.length&&!XF.isElementVisible(b)&&b.get(0).scrollIntoView(!0);d.loading=!1})});a.trigger("quick-edit:show")})},editSubmit:function(a,b){if(!b.errors&&!b.exception){a.preventDefault();b.message&&XF.flashMessage(b.message,3E3);var d=this.$editorTarget,c=this;XF.setupHtmlInsert(b.html,function(a,e,g){e=c.options.editorTarget;e=e.replace(/<|\|/g,"").replace(/#[a-zA-Z0-9_-]+\s*/,"");var f=a.find(e);f.hide();d.replaceWith(f);c.$editorTarget=f;XF.activate(f);c.stopEditing(!1,
function(){f.xfFadeDown();c.$editForm.trigger("quickedit:editcomplete",b)})})}},cancelClick:function(a){this.stopEditing(!0)},stopEditing:function(a,b){var d=this.$editorTarget,c=this.$editForm,h=this,f=function(){d.parent().removeClass("is-editing");a&&d.xfFadeDown();b&&b();c.remove();h.$editForm=null};c?c.xfFadeUp(null,f):f()}});XF.QuoteClick=XF.Click.newHandler({eventNameSpace:"XFQuoteClick",options:{quoteHref:null,editor:".js-quickReply .js-editor"},init:function(){this.options.quoteHref||console.error("Must be initialized with a data-quote-href attribute.")},
