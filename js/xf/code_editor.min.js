...
!function(b,e,d,f){XF.CodeEditor=XF.Element.newHandler({options:{indentUnit:4,indentWithTabs:!0,lineNumbers:!0,lineWrapping:!1,autoCloseBrackets:!0,mode:null,config:null,submitSelector:null,scrollbarStyle:"simple"},editor:null,$wrapper:null,init:function(){if(this.$target[0].parentNode.scrollHeight)this.initEditor();else this.$target.oneWithin("toggle:shown overlay:showing tab:shown",XF.proxy(this,"initEditor"))},initEditor:function(){var a=this.$target,c={};if(!a.data("cmInitialized")){try{c=b.parseJSON(this.options.config)}catch(g){c=
this.options.config}this.editor=CodeMirror.fromTextArea(a.get(0),b.extend({mode:this.options.mode,indentUnit:this.options.indentUnit,indentWithTabs:this.options.indentWithTabs,lineNumbers:this.options.lineNumbers,lineWrapping:this.options.lineWrapping,autoCloseBrackets:this.options.autoCloseBrackets,readOnly:a.prop("readonly"),autofocus:a.prop("autofocus"),scrollbarStyle:this.options.scrollbarStyle},c));this.$wrapper=b(this.editor.getWrapperElement());this.$wrapper.addClass(a.attr("class")).attr("dir",
"ltr");a.attr("class","");this.editor.refresh();XF.layoutChange();this.editor.on("keydown",XF.proxy(this,"keydown"));a.closest("form").on("ajax-submit:before",XF.proxy(this,"onSubmit"));a.trigger("code-editor:init",this.editor);a.data("cmInitialized",!0)}},onSubmit:function(a){this.editor.save()},keydown:function(a,c){if(XF.isMac()&&c.metaKey&&c.ctrlKey&&70==c.which||!XF.isMac()&&122==c.which)c.preventDefault(),a.setOption("fullScreen",!a.getOption("fullScreen"));27==c.which&&(c.stopPropagation(),
a.getOption("fullScreen")&&a.setOption("fullScreen",!1));if((83==c.which||13==c.which)&&(XF.isMac()?c.metaKey:c.ctrlKey)){c.preventDefault();a=b(a.getTextArea()).closest("form");c=this.options.submitSelector;var g=a.find(c);c&&g.length?a.find(c).click():a.submit()}}});XF.CodeEditorSwitcherContainer=XF.Element.newHandler({options:{switcher:".js-codeEditorSwitcher",templateSuffixMode:0},$switcher:null,editor:null,loading:!1,init:function(){this.$target.on("code-editor:init",XF.proxy(this,"initEditor"))},
initEditor:function(a,b){var c=this.$target.find(this.options.switcher);if(c.length){this.$switcher=c;if(c.is("select, :radio"))c.on("change",XF.proxy(this,"change"));else if(c.is("input:not(:checkbox :radio)"))c.on("blur",XF.proxy(this,"blurInput")),setTimeout(function(){c.trigger("blur")},100);else{console.warn("Switcher only works for text inputs, radios and selects.");return}this.editor=b}else console.warn("Switcher container has no switcher: %o",this.$target)},change:function(a){a=this.$switcher.find(":selected").val();
this.switchLanguage(a)},blurInput:function(a){a=this.$switcher.val();this.options.templateSuffixMode&&(a=a.toLowerCase(),a=0<a.indexOf(".less")?"less":0<a.indexOf(".css")?"css":"html");this.switchLanguage(a)},switchLanguage:function(a){if(!this.loading){var c=this,d=this.editor,e=b(d.getTextArea());d.save();e.data("lang")!=a&&setTimeout(function(){var d="public"==b("html").data("app")?"index.php?misc/code-editor-mode-loader":"admin.php?templates/code-editor-mode-loader";XF.ajax("post",XF.canonicalizeUrl(d),
{language:a},XF.proxy(c,"handleAjax")).always(function(){c.loading=!1})},200)}},handleAjax:function(a){if(!a.errors&&!a.exception){a.redirect&&XF.redirect(a.redirect);var c=this.editor,d=b(c.getTextArea());XF.setupHtmlInsert(a.html,function(e,f){e="";a.mime?e=a.mime:a.mode&&(e=a.mode);c.setOption("mode",e);d.data("lang",a.language);d.data("config",JSON.stringify(a.config));a.config&&b.each(a.config,function(a,b){c.setOption(a,b)})})}}});XF.Element.register("code-editor","XF.CodeEditor");XF.Element.register("code-editor-switcher-container",
