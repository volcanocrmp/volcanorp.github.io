...
<head>
	...
	<title>Ariant RolePlay - Донат</title>
</head>
<body>
		...
		<div class="container nav wow fadeInDown" data-wow-delay="1s">
			...
			<div class="col-md-12 post">
				<h1>
					ПОПОЛНЕНИЕ СЧЁТА АККАУНТА<span class="date"></span>
				</h1>
				<p>
					<html>
<head>
...
<hr>
<p><h3>Платёж прошёл неудачно!</h3></p>
Попробуйте ещё раз! Если ошибка не пропала, обратитесь в тех.поддержку vk.com/canberrarp
